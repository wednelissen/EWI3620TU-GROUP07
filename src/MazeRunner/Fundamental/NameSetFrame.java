...
public class NameSetFrame extends JFrame implements ActionListener {
	...
	private JLabel Melding = new JLabel(
			"If no name is entered, 'AAA' will be used.");
	...
	/**
	 * creert een Jframe met twee in te vullen tekst vakken voor de breedte en
	 * de hoogte. dit Jframe is standaard niet zichtbaar.
	 */
	public NameSetFrame() {
		setTitle("Name");
