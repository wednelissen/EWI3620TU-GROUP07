...
/**
 * The OBJLoader reads .obj files and turns them into arrays for Model.
 * 
 * @author Huib
 * 
 */
public class OBJLoader {
	...
	/**
	 * Reads the file with a buffered reader. Turns all the arraylist into
	 * arraylist with vertices, verticenormals, texcoords and faces. Returns a
	 * Model with all the info from the .obj file
	 * 
	 * @param fileName
	 *            Sourcename
	 * @return a Model with all the info from the .obj file
	 */
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				if (line.startsWith("v ")) {
					...
					// De plek in de arraylijsten waar de vertex wordt
					// aangegeven
					...
					// De plek in de arraylijsten waar de texture wordt
					// aangegeven
					...
					// De plek in de arraylijsten waar de normals wordt
					// aangegeven
					...
					m.addFace(new Face(vertexIndices, textureIndices,
							normalIndices));
				}
			}
			reader.close();
