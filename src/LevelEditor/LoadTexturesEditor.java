...
public class LoadTexturesEditor {
	...
	public LoadTexturesEditor() {
		...
		addTextureToList(loadingTexture("removeLastPointGuardButton.png"), "removeLastPointGuardButton");
		addTextureToList(loadingTexture("showAllGuardsButton.png"), "showAllGuardsButton");
	...
	public Texture loadingTexture(String fileName) {
		...
		try {
			...
			System.out.println(fileName + " is null, default texture ingeladen");
			tempTexture = defaultTexture;
		}
		return tempTexture;
	}
